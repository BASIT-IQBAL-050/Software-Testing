...
public class StudentAccountTest extends StudentLoginBase {
    ...
    @Test(dependsOnMethods = "verifyLecturesAreAccessible")
    public void verifyLectureContentAreAccessable(){
        System.out.println("Starting verifyLectureContentAreAccessable test");
        NavigationUtil.clickLectureTab();
        ...
        try {
            ...
            System.out.println("verifyLectureContentAreAccessable test completed successfully");
        } catch (Exception e) {
            System.err.println("Failed to verify if lectures are clickable: " + e.getMessage());
            Assert.fail("Failed to verify if lectures are clickable", e);
        }
